...
registerMooseObject("fe2App", FE2SolutionAux);

InputParameters
FE2SolutionAux::validParams()
{
...
FE2SolutionAux::FE2SolutionAux(const InputParameters & parameters)
  : AuxKernel(parameters),
    _solution_object(getUserObject<FE2SolutionUserObject>("solution")),
